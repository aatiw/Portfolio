...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Atharva Tiwari, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
    "I’m currently helping businesses bring their visions to life through interactive digital solutions.",
  resumeLinkText: "Download Resume",
  resumeLink: "https://drive.google.com/file/d/16A9mg5iWzDa6P3qbzDEplYYpE79qA7jo/view?usp=sharing",
};
...
export const EXPERIENCES = [
  {
    yearRange: "May 2024 - June 2024",
    title: "Marketing Research Analyst Intern",
    location: "Vardhan Consulting Engineers",
    description: [
      "Conducted analysis of sales and revenue data to align with key business objectives and address stakeholders needs.",
      "Developed actionable insights that drove sales growth by 7%, supporting revenue optimization and customer engagement strategies.",
      "Utilized Tableau and Excel to create comprehensive reports and dashboards.",
    ],
  },
  {
    yearRange: "2021 — 2023",
...
export const CONTACT_CONTENT = {
  ...
  email: "aatiw69@gmail.com",
  socialLinks: [
    {
      platform: "Twitter",
      url: "https://x.com/aatiw69",
      ariaLabel: "Follow me on Twitter",
      icon: "RiTwitterXFill",
    },
    {
      platform: "GitHub",
      url: "https://github.com/aatiw",
      ariaLabel: "View my GitHub profile",
      icon: "RiGithubFill",
    },
    {
      platform: "LinkedIn",
      url: "https://www.linkedin.com/in/atharva-tiwari-7b673322b/",
      ariaLabel: "Connect with me on LinkedIn",
      icon: "RiLinkedinFill",
    },
  ],
  footerText: `© ${new Date().getFullYear()} Atharva Tiwari. All rights reserved.`,
};
